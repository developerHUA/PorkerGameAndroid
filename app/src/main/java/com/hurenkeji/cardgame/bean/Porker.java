...
public class Porker {
    ...
    public int getResourceId() {
        ...
        switch (porkerType) {
            case RED_HEART:
                id = PorkerResouceId.RED_HEART_ID[porkerId];
                break;
            case PLUM_BLOSSOM:
                id = PorkerResouceId.PLUM_BLOSSOM_ID[porkerId];
                break;
            case BLACK_HEART:
                id = PorkerResouceId.BLACK_HEART_ID[porkerId];
                break;
            case BLOCK:
                id = PorkerResouceId.BLOCK_ID[porkerId];
                break;
            case SMALL_KING:
                id = PorkerResouceId.SMALL_KING_ID;
                break;
            case BIG_KING:
                id = PorkerResouceId.BIG_KING_ID;
                break;
        }
        return id;
    }
